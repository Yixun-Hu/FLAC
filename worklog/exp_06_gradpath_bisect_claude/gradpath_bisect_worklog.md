...
## 2026-07-06T23:29:21-04:00 — S2 VERDICT: lr monotone in the WRONG direction; registered stop; exp_06 closes
- **Result (screens, K=8 seed 42, full split):** L1 5e-7: 9.087/0.953/38.75; L2 5e-6 (V1p): 9.235/0.928/38.73; L3 2e-5: 9.596/0.929/40.15; L4 4.2e-5: 9.866/0.953/39.92; L5 InverseLR-restart: 10.099/0.978/40.35 (T60/C50/EDT). No finalist (thresholds 8.65/37.3). Both registered predictions partially falsified: lr does not recover (Yixun's Q2 answered: monotone worse with lr), AND the endpoint is not lr-invariant (checkpoint-selection story in its simple form dies too — damage grows with cumulative lr-distance, no universal plateau in range).
- **Analysis** — unified conclusion: training under this exact (upstream-identical) objective on this data monotonically departs the released point; the released checkpoint is not near this objective's optimum on our data. Remaining explanations are outside recipe space: dataset-version/environment lineage or source-side checkpoint selection. S3.3 aug-off arm correctly NOT triggered (condition was S2-flat + material S3.2c; S2 is monotone and aug bias was 10× too small for T60).
- **Decision** — registered stop; exp_06 closes with results/analysis/HTML. Fine-tune-based H3-vs-exp_01 is declared unreachable via recipe; project routes: (A) matched comparison, (B) from-scratch fa_invariant.
