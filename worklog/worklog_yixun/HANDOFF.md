...
**Last updated:** 2026-08-13 ~12:00 EDT — model change Opus 5 → **Fable 5 (xhigh)**, header refresh only (full rewrite was 2026-08-10, state continuously logged since). **Current live state:** nothing of ours running; exp_14 plan at Rev 3+fixes, APPROVE-ready, **awaiting Yixun's final go** (12-day sequential training, DS-PA → audit gate → DS-CS3); A6 rotation head-to-head COMPLETE and decisive (FA flat at 90°, both vanillas degrade, 45° control valid); A4 complete (FA 6/0 in the 40k budget); A5 v1 withdrawn / v2 pilot-only. Yixun's exp12A finished; exp12C ~45k/67.5k. Standing rules: status+ETD for ALL experiments every response; ask-before-choosing (CLAUDE.md 2026-08-11).
