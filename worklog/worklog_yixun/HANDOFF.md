...
- **B-V EXTEND — SECOND LEG (GPU 1, PID 3986188, wandb run `FLAC_exp07_BVextend/969vypp5`, resumed 2026-07-16 16:39 from ckpt 77500):** → 100k, ETA ~Jul 17 ~19:15–19:40 EDT (verified 17:44: global step ~78.2k, 10.4 GiB, healthy). New ckpts NEST under `outputs_FLAC/exp07_BVextend/FLAC_exp07_BVextend/<run>/checkpoints/` (wandb path; screens/monitors use recursive find). Leg-2 ckpt monitor armed (80k/90k/100k + death guard). **Screens done (EMA K=8 s42):** 70k 9.107/0.9368/40.538/R6.486 · 72.5k 9.325/0.9712/40.547/R6.359 · 75k 9.436/0.9688/39.782/R6.470 · 77.5k 9.612/0.9716/41.479/R6.596 · 80k 9.866/0.9540/41.472/**R6.738 = 3rd consecutive lineage max** — R@1 climb is real (~5.7× eval σ; gap to released 0.89→0.32; could touch 7.06 near 100k), T60/C50/EDT band-oscillate. ETA revised ~20:00 Jul 17 (screen co-location cost; verified 20:10 @ step ~80.2k, 1.82 it/s). *(First leg PID 3737059 STOPPED 13:35 at ckpt 77500 for the B-F reprioritization — `bv_extend_stop_restart.md`.)*
