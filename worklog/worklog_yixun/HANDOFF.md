...
- **B-V EXTEND — SECOND LEG (GPU 1, PID 3986188, wandb run `FLAC_exp07_BVextend/969vypp5`, resumed 2026-07-16 16:39 from ckpt 77500):** → 100k, ETA ~Jul 17 ~19:15–19:40 EDT (verified 17:44: global step ~78.2k, 10.4 GiB, healthy). New ckpts NEST under `outputs_FLAC/exp07_BVextend/FLAC_exp07_BVextend/<run>/checkpoints/` (wandb path; screens/monitors use recursive find). Leg-2 ckpt monitor armed (80k/90k/100k + death guard). **Screens done (EMA K=8 s42):** 70k 9.107/0.9368/40.538/R6.486 · 72.5k 9.325/0.9712/40.547/R6.359 · 75k 9.436/0.9688/39.782/R6.470 · 77.5k 9.612/0.9716/41.479/R6.596 · 80k 9.866/0.9540/41.472/R6.738 · 90k 9.836/1.0110/42.359/**R6.817 = 4th consecutive lineage max** (gap to released 0.24; ≈ released K=1 6.83; FD best-yet 0.3088) — R@1 climb is real, T60/C50/EDT band-oscillate. ETA ~19:30–20:00 Jul 17 (verified 07:57 @ step ~90.2k, 1.88 it/s). **Post-100k auto-plan:** screen 100k (EMA+online) + the 6 off-10k ckpts 82.5/85/87.5/92.5/95/97.5 (EMA-only, selcurve style) ≈ 1.7 h on GPU 1 → full 13-pt extend curve → best-ckpt verdict report. **aug291k verified 55,000 @ 05:14 Jul 17, cadence 3h39m → GPU 0 frees ~23:30 tonight → M1 probe ~23:35 → RUNG REPORT ~24:00, then HOLD.** *(First leg PID 3737059 STOPPED 13:35 at ckpt 77500 for the B-F reprioritization — `bv_extend_stop_restart.md`.)*
