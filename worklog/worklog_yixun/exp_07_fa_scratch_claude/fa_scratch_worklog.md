...
- Ext screens (EMA s42): 70k 8.079(lineage-best T60)/0.9390/37.228/R6.233 · 75k 9.116/0.9407/39.575/R6.675 · 80k 8.804/**0.9332 (program-best C50)**/37.132/**R6.833** (0.07 below crossing) · 85k 8.906/0.9569/38.023/R6.249 (oscillation — same peak-and-swing shape as the 8×8 extend, whose parity landed at 92.5k after identical dips; hunt continues through the 90–95k precedent zone). Ops: teardown killed the extension twice (11:45 leg died ~15:35); re-resumed 16:32 from 72.5k (`mkum1n79`).
