...
1. G1 metric-level flatness is measured (C₄ sweep spreads ≤0.016, 10⁻²–10⁻³ of the 45°-control break) and the invariance argument is architectural; the registered G1's conditioning-rel-L2 and waveform-floor sub-tests were not re-run (recorded departure).
