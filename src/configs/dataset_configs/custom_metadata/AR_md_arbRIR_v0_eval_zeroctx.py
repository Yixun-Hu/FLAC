...
Context-ablation control (zeroctx) for the advisor's "context RIR = material
proxy" hypothesis. Cloned from AR_md_arbRIR_v0_eval_A.py with the pose logic
left BYTE-IDENTICAL; only md['context_audio'] is overridden (zeros). Scheme-A
...
_SCHEME = "zeroctx"  # Scheme-A poses; context audio zeroed
